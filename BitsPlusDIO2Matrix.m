...
encodedDIOdata(1,(14:2:508)+shift,3) = bin2dec(databin(:,4:11));                                             % LSB DIO
encodedDIOdata(1,(14:2:508)+shift,2) = bin2dec([databin(:,1),repmat('00000',length(data),1),databin(:,2:3)]); % MSB DIO
