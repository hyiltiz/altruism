function out = xuanze_item()
  % 选择利他或是利己
  % 150323
  % edited by Hormetjan, 20150521
  % return based on the query, or return all if no query is specified
  ...
  if nargin < 1
    ...
    item_con = xuanze_item(item_num, item_cond);
  end
end
